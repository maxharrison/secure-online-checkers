...
/* package on-chain-checkers-0.1.0.0 */
#ifndef VERSION_on_chain_checkers
#define VERSION_on_chain_checkers "0.1.0.0"
#endif /* VERSION_on_chain_checkers */
#ifndef MIN_VERSION_on_chain_checkers
#define MIN_VERSION_on_chain_checkers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_on_chain_checkers */
...
#define CURRENT_COMPONENT_ID "on-chain-checkers-0.1.0.0-EYe5Ab9tdup7CIpkQjgoTs-on-chain-checkers"
